   ...
   <div id="index-mian">
      <div class="cont-left">
         <div class="profile">           
           ...
           <img src="{$config_siteurl}statics/themes/L3_Global/images/police11.png">广安市公安局协兴镇派出所成立于1997年，现有警力32人，其中班子成员5人，所有人员按三队一室配置，下设6个警务组。钢都派出所管理区位于辽宁重镇镁都大石桥市城区东部中心地段（石桥大街48号），地处城乡结合部，辖区地域面积达16.8平方公里，辖区含8个社区....
           </div>
         </div>
        ...
        <content action="lists" catid="$catid" order="id DESC" num="20" page="$page">
         <ul class="News-ul">
            <volist name="data" id="vo">
                <li><a href="{$vo.url}"><span>[{$vo.updatetime|date='Y-m-d',###}]</span><img src="{$config_siteurl}statics/themes/L3_Global/images/police8.png">{$vo.title|str_cut=###,25}</a></li>
            </volist>
         </ul>
         <div class="page-flip">
            {$pages}
