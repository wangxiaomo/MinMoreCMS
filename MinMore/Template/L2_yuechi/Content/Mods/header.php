<div class="header_box">
	<div class="header">
    	<div class="top">
            ...
            <span class="top_search"><input type="text" class="search-box" placeholder="请输入内容" /><img src="{$config_siteurl}statics/themes/L2_岳池/images/icon/search.png" class="search-btn" /></span>
        </div>
    </div>
</div>
<div class="nav_box">
