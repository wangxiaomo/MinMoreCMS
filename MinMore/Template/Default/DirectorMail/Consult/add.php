...
<template file="DirectorMail/Public/button.php"/>
  ...
  <div class="content-fd">
    <div class="director-mail-description" style="margin-top:-100px;">
       <if condition="$headicon eq '建言献策'">
        <p>1、本栏目主要方便群众向公安机关提出自己的建议。</p>
        <p>2、请您认真填写完整、准确、真实、有效的信息，不得发布不符合国家法律法规和任何有害的信息。</p>
        <p>3、建言内容不要超过500字。</p>
       <elseif condition="$headicon eq '网上咨询'" />
        <p>1、本栏目主要提供涉及公安机关的相关法律法规、政策和服务事项的咨询。</p>
        <p>2、请您认真填写完整、准确、真实、有效的信息，不得发布不符合国家法律法规和任何有害的信息。</p>
        <p>3、咨询内容不要超过500字。</p>
       <elseif condition="$headicon eq '网上举报'" />
        <p>1、本栏目受理涉及广安市所辖区域内的违法犯罪案件和投诉举报，如果不属于此范围，请到其他地区举报。如果您的情况紧急，请直接拨打110。</p>
        <p>2、请您认真填写完整、准确、真实、有效的信息，不得发布不符合国家法律法规和任何有害的信息。</p>
        <p>3、举报内容不要超过500字。</p>
       <else />
        <p>1、本栏目受理对我市各级公安机关执法问题或公安民警的违法违纪问题的投诉举报。</p>
        <p>2、请您认真填写完整、准确、真实、有效的信息，不得发布不符合国家法律法规和任何有害的信息。</p>
        <p>3、投诉内容不要超过500字。</p>
       </if>
    </div>
