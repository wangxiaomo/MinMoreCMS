...
<div id="header">
  <h1 id="rLogo"><a href="{$config_siteurl}" title="到首页"><img src="{$config_siteurl}statics/images/logo.png" alt="到搜搜首页" /></a></h1>
  <div class="sBox">
...
<div id="footer" ss_c="tshh">
  Copyright &copy; 2012 - 2016 www.minmore.com. All Rights Reserved. </div>
