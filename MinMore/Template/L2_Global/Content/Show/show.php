...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"16"},"share":{"bdSize":16}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
    ...
    <div class="up_right float_right">
            	...
            	<ul>
                    <content action="lists" catid="2" order="id DESC" num="3">
                        <volist name="data" id="vo">
                            <li><img src="{$config_siteurl}statics/themes/L2_Global/images/icon/num_1.png" /><a href="#">省内煤市要闻回顾</a></li>
                        </volist>
                    </content>
                </ul>
            </div>
        ...
        <div class="enter">
            <ul>
                <li><img src="{$config_siteurl}statics/themes/L2_Global/images/enter_1.png" /></li>
                <li><img src="{$config_siteurl}statics/themes/L2_Global/images/enter_2.png" /></li>
