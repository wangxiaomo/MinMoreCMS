        ...
        <script>
            $(function(){
                ...
                $(".send-sms-vcode").on("click", function(){
                    ...
                    $.post("/index.php?g=api&m=site&a=query_order_phone", {caseID:caseID,mobile:mobile,round:value}, function(d){
                        if(d==0){
        ...
        <script>
            $(function(){
                $('#pingjia').on("click",function(){
                        ...
                        $.post("/index.php?g=api&m=site&a=order_pingjia",{kuang:xuan},function(data){
                            if(data==1){
                                alert("提交成功，感谢您的评价");
                                $('#pingjia').attr('disabled','true');
                                $("#pingjia").val("提交成功");
