        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            ...
            <tr>
              ...
              <span class="gray">模板名称不带后缀，不设置为使用默认列表，增加列表模板可在/MinMore/Application/Content/View/Listtemplate/里增加文件</span></td>
            </tr>
          </table>
        </div>
      </div>
          ...
          <table width="100%" class="table_form ">
            ...
            <tr style="display:none" id="tr_domain">
              ...
              <td><input type="text" value="" size="50" class="input" id="url" name="info[url]">
                <span class="gray"> 域名可为空，格式应该为http://www.www.minmore.com/</span></td>
            </tr>
          </table>
        </div>
      </div>
