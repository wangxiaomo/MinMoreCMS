...
<div class="wrap J_check_wrap">
  ...
  <table width="100%" cellspacing="0">
      <thead>
        <tr>
          <td width="100" align="left"><input type="checkbox" class="J_check_all" data-direction="x" data-checklist="J_check_x">全选</td>
      ...
      <volist name="data" id="vo">
        <tr>
          ...
          <td><a href="{$vo.url}" title="{$vo.title}" target="_blank">{$vo.title}</a></td>
  ...
  <div class="btn_wrap">
      <div class="btn_wrap_pd">
        ...
        <button class="btn J_ajax_submit_btn" type="submit" data-action="{:U('Content/html')}">更新HTML</button>
      </div>
    </div>
  </form>
</div>
