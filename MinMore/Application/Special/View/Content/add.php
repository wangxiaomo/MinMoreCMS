      ...
      <table width="100%">
         <tr>
          <td><div  style="text-align: center;"><input type='hidden' name='info[thumb]' id='thumb' value=''>
			<a href='javascript:void(0);' onclick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','Special','{$catid}','<?php echo upload_key('1,jpg|jpeg|gif|png|bmp,1,,,1'); ?>');return false;">
			<img src='{$config_siteurl}statics/images/icon/upload-pic.png' id='thumb_preview' width='135' height='113' style='cursor:hand' /></a>
