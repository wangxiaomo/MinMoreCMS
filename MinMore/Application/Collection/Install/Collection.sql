...
-- ----------------------------
-- Table structure for `minmore_collection_content`
-- ----------------------------
DROP TABLE IF EXISTS `minmore_collection_content`;
CREATE TABLE `minmore_collection_content` (
...
-- ----------------------------
-- Table structure for `minmore_collection_history`
-- ----------------------------
DROP TABLE IF EXISTS `minmore_collection_history`;
CREATE TABLE `minmore_collection_history` (
...
-- ----------------------------
-- Table structure for `minmore_collection_node`
-- ----------------------------
...
CREATE TABLE IF NOT EXISTS `minmore_collection_node` (
  ...
  `role` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '角色ID',
...
-- ----------------------------
-- Table structure for `minmore_collection_program`
-- ----------------------------
DROP TABLE IF EXISTS `minmore_collection_program`;
CREATE TABLE `minmore_collection_program` (
  `id` int(10) unsigned NOT NULL auto_increment,
