      ...
      <table width="100%" cellspacing="0">
        <thead>
          <tr>
            ...
            <option value="{:U('index' ,array('isadmin'=>1,'status'=>0) )}"<if condition="$typeid eq '0'">selected</if>>未回复</option>
            <option value="{:U('index' ,array('isadmin'=>1,'status'=>1) )}"<if condition="$typeid eq '1'">selected</if>>已回复</option>
           </select>
            </td>
