...
<div>
	<span>评价：</span>
	<input type="radio" name="evaluation" value="verysatisfied" checked>非常满意&nbsp;&nbsp;&nbsp;
        <input type="radio" name="evalueation" value="satisfied">满意&nbsp;&nbsp;&nbsp;
        <input type="radio" name="evaluation" value="unsatisfy">不满意&nbsp;&nbsp;&nbsp;
	<input type="button" id="evaluate_submit" value="确定">
</div>
</div>
<script>
